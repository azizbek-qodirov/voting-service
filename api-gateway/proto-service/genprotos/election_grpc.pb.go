...
type ElectionServiceClient interface {
	...
	GetAllElections(ctx context.Context, in *Filter, opts ...grpc.CallOption) (*GetAllElection, error)
}
...
func (c *electionServiceClient) CreateElection(ctx context.Context, in *Election, opts ...grpc.CallOption) (*Void, error) {
	out := new(Void)
	err := c.cc.Invoke(ctx, "/voting_proto.ElectionService/CreateElection", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *electionServiceClient) DeleteElection(ctx context.Context, in *ById, opts ...grpc.CallOption) (*Void, error) {
	out := new(Void)
	err := c.cc.Invoke(ctx, "/voting_proto.ElectionService/DeleteElection", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *electionServiceClient) UpdateElection(ctx context.Context, in *Election, opts ...grpc.CallOption) (*Void, error) {
	out := new(Void)
	err := c.cc.Invoke(ctx, "/voting_proto.ElectionService/UpdateElection", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *electionServiceClient) GetByIdElection(ctx context.Context, in *ById, opts ...grpc.CallOption) (*Election, error) {
	out := new(Election)
	err := c.cc.Invoke(ctx, "/voting_proto.ElectionService/GetByIdElection", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *electionServiceClient) GetAllElections(ctx context.Context, in *Filter, opts ...grpc.CallOption) (*GetAllElection, error) {
	out := new(GetAllElection)
	err := c.cc.Invoke(ctx, "/voting_proto.ElectionService/GetAllElections", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ElectionServiceServer interface {
	...
	GetAllElections(context.Context, *Filter) (*GetAllElection, error)
...
func (UnimplementedElectionServiceServer) GetAllElections(context.Context, *Filter) (*GetAllElection, error) {
...
func _ElectionService_CreateElection_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/voting_proto.ElectionService/CreateElection",
	}
...
func _ElectionService_DeleteElection_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/voting_proto.ElectionService/DeleteElection",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ElectionService_UpdateElection_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/voting_proto.ElectionService/UpdateElection",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ElectionService_GetByIdElection_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/voting_proto.ElectionService/GetByIdElection",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ElectionService_GetAllElections_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/voting_proto.ElectionService/GetAllElections",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ElectionServiceServer).GetAllElections(ctx, req.(*Filter))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ElectionService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "voting_proto.ElectionService",
	...
	Metadata: "proto-service/voting-protos/election.proto",
}

...
type PublicServiceClient interface {
	...
	GetById(ctx context.Context, in *PublicGetById, opts ...grpc.CallOption) (*Public, error)
	GetAll(ctx context.Context, in *PublicGetAllReq, opts ...grpc.CallOption) (*PublicGetAllResp, error)
}
...
func (c *publicServiceClient) Create(ctx context.Context, in *PublicCreate, opts ...grpc.CallOption) (*Void, error) {
	out := new(Void)
	err := c.cc.Invoke(ctx, "/voting_proto.PublicService/Create", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *publicServiceClient) Update(ctx context.Context, in *PublicUpdate, opts ...grpc.CallOption) (*Void, error) {
	out := new(Void)
	err := c.cc.Invoke(ctx, "/voting_proto.PublicService/Update", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *publicServiceClient) Delete(ctx context.Context, in *PublicDelete, opts ...grpc.CallOption) (*Void, error) {
	out := new(Void)
	err := c.cc.Invoke(ctx, "/voting_proto.PublicService/Delete", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *publicServiceClient) GetById(ctx context.Context, in *PublicGetById, opts ...grpc.CallOption) (*Public, error) {
	out := new(Public)
	err := c.cc.Invoke(ctx, "/voting_proto.PublicService/GetById", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *publicServiceClient) GetAll(ctx context.Context, in *PublicGetAllReq, opts ...grpc.CallOption) (*PublicGetAllResp, error) {
	out := new(PublicGetAllResp)
	err := c.cc.Invoke(ctx, "/voting_proto.PublicService/GetAll", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PublicServiceServer interface {
	...
	GetById(context.Context, *PublicGetById) (*Public, error)
	GetAll(context.Context, *PublicGetAllReq) (*PublicGetAllResp, error)
...
func (UnimplementedPublicServiceServer) GetById(context.Context, *PublicGetById) (*Public, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetById not implemented")
}
func (UnimplementedPublicServiceServer) GetAll(context.Context, *PublicGetAllReq) (*PublicGetAllResp, error) {
...
func _PublicService_Create_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/voting_proto.PublicService/Create",
	}
...
func _PublicService_Update_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/voting_proto.PublicService/Update",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _PublicService_Delete_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/voting_proto.PublicService/Delete",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _PublicService_GetById_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/voting_proto.PublicService/GetById",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PublicServiceServer).GetById(ctx, req.(*PublicGetById))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _PublicService_GetAll_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/voting_proto.PublicService/GetAll",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PublicServiceServer).GetAll(ctx, req.(*PublicGetAllReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var PublicService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "voting_proto.PublicService",
	...
	Metadata: "proto-service/voting-protos/public.proto",
}

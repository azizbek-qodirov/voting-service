...
func (c *candidateServiceClient) CreateCandidate(ctx context.Context, in *CandidateCreate, opts ...grpc.CallOption) (*Void, error) {
	out := new(Void)
	err := c.cc.Invoke(ctx, "/voting_proto.CandidateService/CreateCandidate", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *candidateServiceClient) DeleteCandidate(ctx context.Context, in *ById, opts ...grpc.CallOption) (*Void, error) {
	out := new(Void)
	err := c.cc.Invoke(ctx, "/voting_proto.CandidateService/DeleteCandidate", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *candidateServiceClient) UpdateCandidate(ctx context.Context, in *Candidate, opts ...grpc.CallOption) (*Void, error) {
	out := new(Void)
	err := c.cc.Invoke(ctx, "/voting_proto.CandidateService/UpdateCandidate", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *candidateServiceClient) GetByIdCandidate(ctx context.Context, in *ById, opts ...grpc.CallOption) (*Candidate, error) {
	out := new(Candidate)
	err := c.cc.Invoke(ctx, "/voting_proto.CandidateService/GetByIdCandidate", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *candidateServiceClient) GetAllCandidates(ctx context.Context, in *Filter, opts ...grpc.CallOption) (*GetAllCandidate, error) {
	...
	err := c.cc.Invoke(ctx, "/voting_proto.CandidateService/GetAllCandidates", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _CandidateService_CreateCandidate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/voting_proto.CandidateService/CreateCandidate",
	}
...
func _CandidateService_DeleteCandidate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/voting_proto.CandidateService/DeleteCandidate",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _CandidateService_UpdateCandidate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/voting_proto.CandidateService/UpdateCandidate",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _CandidateService_GetByIdCandidate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/voting_proto.CandidateService/GetByIdCandidate",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _CandidateService_GetAllCandidates_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/voting_proto.CandidateService/GetAllCandidates",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var CandidateService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "proto-service/voting-protos/candidate.proto",
}
